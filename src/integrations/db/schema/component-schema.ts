...
import { appAssetSchema } from "./app-asset-schema"
...
export const components = pgTable(
  "components",
  {
    ...
    assetId: text("assetId").references(() => appAssetSchema.id, {
      onDelete: "cascade",
    }),
...
export const componentsRelations = relations(components, ({ one }) => ({
  ...
  asset: one(appAssetSchema, {
    fields: [components.assetId],
    references: [appAssetSchema.id],
  }),
}))
